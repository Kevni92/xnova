...
export function queueMarkup(planet) {
  const queue = planet.buildQueue.length === 0
    ? '<div class="empty-state"><span class="empty-state__icon">✓</span><strong>Keine Bauauftàge</strong><p>Der nächste Ausbau kann sofort beginnen.</p></div>'
